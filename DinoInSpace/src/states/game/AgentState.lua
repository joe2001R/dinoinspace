AgentState = Class(BaseState)

function AgentState:construct()
...
function AgentState:updateCam(dt)
...
function AgentState:playerLose(dt)
...
function AgentState:enter() end
function AgentState:exit()
    gSounds['music']:stop()
end